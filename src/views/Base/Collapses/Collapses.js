      ...
      <div className="container">
        ...
        <div className="card shadow">
          ...
          <div className="form-group ">
            <span className="input-group-text" id="basic-addon1">Segment data</span>{
                ...
                return (
                  <div className="form-group">
                    ...
                    <div className="drop">
                      <div key={index}>
                        <Form as={Col}>
                          ...
                          <select className="browser-default custom-select" onChange={(e) => this.handlenewChange(e, index)}>
                            <option>---</option>
                            <option>></option>
                            <option>{"<"}</option>
                            <option>=</option>
                      ...
                      <div className="input-group">
                        <div className="input-group-prepend">
                          <div key={index}>
                            ...
                            <input type="text" className="enter_value" id="value" onChange={(e) => this.handleChange(e, index)} placeholder=" enter the value" aria-label="Value" aria-describedby="basic-addon3" />
                          </div>
                        </div>
                      </div>
                    </form>
                    ...
                    <div className="bt-style">
                      <button className="remove_btn" onClick={(e) => this.handleRemove(e)}>Remove</button>
                    </div>
                  </div>
